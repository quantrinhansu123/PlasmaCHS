                                    ...
                                    <div className="md:col-span-2 lg:col-span-1">
                                        ...
                                        <div className="relative flex items-center">
                                            <input
                                                ...
                                                className="w-full pl-4 pr-12 py-3 bg-white border border-slate-200 rounded-xl focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 outline-none transition-all font-bold text-slate-900"
                                                required
                                            />
                                            <button
                                                type="button"
                                                onClick={startScanner}
                                                className="absolute right-2 p-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-all flex items-center justify-center shadow-sm"
                                                title="Quét barcode"
                                            >
