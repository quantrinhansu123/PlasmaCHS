...
export default function CylinderRecoveryPrintTemplate({ recovery, items: initialItems, customerName, onPrinted }) {
    ...
    return (
        <div className="recovery-print-page" style={S.page}>
            ...
            <div style={S.infoGrid}>
                ...
                <div style={S.infoItem}>Kho nhận: {recovery.warehouse_id}</div>
