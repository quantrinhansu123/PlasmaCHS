    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 w-full flex-1 flex flex-col mt-1 min-h-0 px-1 md:px-1.5">
      ...
      <div className="bg-white rounded-2xl border border-border shadow-sm flex flex-col flex-1 min-h-0 w-full">
        ...
        {activeView === 'list' ? (
              ...
              {loading ? (
                ...
                <div key={index} className="bg-white border border-primary/10 rounded-2xl p-4 shadow-sm">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <div className="flex items-center gap-1 text-[11px] text-muted-foreground"><MapPin size={10} /> {item.kho}</div>
                  </div>
                  <div className="grid grid-cols-4 gap-2 text-center text-[11px] mb-2 font-bold uppercase text-muted-foreground">
                    <div>Đầu kỳ</div>
                    <div className="text-emerald-600">Bàn giao</div>
                    <div className="text-rose-500">Thu hồi</div>
                    <div className="text-primary">Cuối kỳ</div>
                  </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              <SummaryCard icon={<History />} label="Tổng tồn đầu máy" value={stats_summary.totalOpening} color="blue" />
            ...
            <div className="bg-white border border-border rounded-xl p-6 shadow-sm">
              <h3 className="text-lg font-bold text-foreground mb-4">Top 10 Khách hàng sử dụng máy</h3>
        ...
        <div className="px-4 py-4 border-t border-border flex items-center justify-between bg-muted/5">
          <span className="text-[12px] text-muted-foreground font-medium">Tổng {filteredData.length} khách hàng có biến động máy</span>
        </div>
      </div>
