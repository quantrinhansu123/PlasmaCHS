...
const CreateMachine = () => {
    ...
    return (
        <>
            {/* 3-Tier Barcode Scanner Component */}
            <BarcodeScanner 
            ...
            <div className="bg-white/80 backdrop-blur-xl rounded-[1.5rem] md:rounded-[2.5rem] shadow-2xl shadow-indigo-900/10 border border-white overflow-hidden relative z-10">
                ...
                {/* Footer Buttons */}
                <div className="p-6 pb-20 md:p-10 bg-gray-50 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6">
                    <p className="hidden md:block text-gray-400 text-sm font-medium italic">* Vui lòng kiểm tra mã Serial trước khi lưu.</p>
