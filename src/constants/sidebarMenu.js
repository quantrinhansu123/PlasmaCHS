...
export const sidebarMenu = [
  ...
  { path: '/van-chuyen', label: 'Vận chuyển', icon: Truck, color: 'text-sky-500', roles: ['Admin', 'Manager'] },
  { path: '/nhiem-vu-giao-hang', label: 'Nhiệm vụ giao hàng', icon: PackageCheck, color: 'text-indigo-500', roles: ['Admin', 'Shipper'] },
